...
const f2014 = fifaData.filter(function (item) {
    return item.Year === 2014 && item.Stage === 'Final'
});
console.log(f2014)
//(b) Away Team name for 2014 world cup final
console.log('task a', f2014[0]['Away Team Name'])
//(c) Home Team goals for 2014 world cup final
console.log('task b', f2014[0]['Home Team Goals'])
//(d) Away Team goals for 2014 world cup final
console.log('task c', f2014[0]['Away Team Goals'])
//(e) Winner of 2014 world cup final */
console.log('task e', f2014[0]['Win conditions'])
